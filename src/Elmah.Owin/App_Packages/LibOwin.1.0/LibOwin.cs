...
namespace Elmah.LibOwin.Infrastructure
{
    using System;
...
namespace Elmah.LibOwin
{
    ...
    using System.Linq;
#if NET_4_0
    using ClaimsPrincipal = System.Security.Principal.IPrincipal;
#else
    ...
    using Elmah.LibOwin.Infrastructure;
    ...
    class OwinRequest : IOwinRequest
    {
        ...
        public Task<IFormCollection> ReadFormAsync()
        {
            ...
            if (form == null)
            {
                ...
                var reader = new StreamReader(Body, Encoding.UTF8, detectEncodingFromByteOrderMarks: true, bufferSize: 4 * 1024);
                var text = reader.ReadToEnd();
                form = OwinHelpers.GetForm(text);
                Set("Microsoft.Owin.Form#collection", form);
            }

            return CompletedTask.Return(form);
        }
#else
    ...
    class OwinResponse : IOwinResponse
    {
        ...
        {
#if NET_4_0
            return Task.Factory.FromAsync(Body.BeginWrite, Body.EndWrite, data, offset, count, null);
#else
